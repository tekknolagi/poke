...
\\{jitter-mode-map}"
  (defconst jitter-font-lock-keywords
    `(;; Highlight C code.  Anything coming in the same line after "code",
      ...
      ;; Highlight keywords.
      ("\\<\\(vm\\|set\\|register-class\\|stack\\|tos-stack\\|ntos-stack\\|early-header-c\\|late-header-c\\|printer-c\\|early-c\\|late-c\\|initialization-c\\|finalization-c\\|state-struct-backing-c\\|state-struct-runtime-c\\|state-initialization-c\\|state-finalization-c\\|wrapped-functions\\|wrapped-globals\\|instruction\\|commutative\\|two-operands\\|hot\\|cold\\|relocatable\\|non-relocatable\\|caller\\|callee\\|code\\|end\\)\\>"
