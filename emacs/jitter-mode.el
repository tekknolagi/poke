...
\\{jitter-mode-map}"
  (defconst jitter-font-lock-keywords
    `(;; Highlight C code.  Anything coming in the same line after "code",
      ...
      ;; Highlight keywords.
      ("\\<\\(vm\\|set\\|register-class\\|stack\\|tos-stack\\|ntos-stack\\|early-header-c\\|late-header-c\\|printer-c\\|rewriter-c\\|early-c\\|late-c\\|initialization-c\\|finalization-c\\|state-struct-backing-c\\|state-struct-runtime-c\\|state-initialization-c\\|state-finalization-c\\|wrapped-functions\\|wrapped-globals\\|instruction\\|commutative\\|two-operands\\|hot\\|cold\\|relocatable\\|non-relocatable\\|caller\\|callee\\|code\\|end\\)\\>"
      ...
      ("\\<\\(JITTER_\\(?:TOP\\|UNDER_TOP\\|PUSH_UNSPECIFIED\\|PUSH\\|DROP\\|DUP\\|SWAP\\|OVER\\|NIP\\|UNARY\\|BINARY\\)_\\)\\([A-Z]+\\)\\>"
       (1 font-lock-preprocessor-face t)
